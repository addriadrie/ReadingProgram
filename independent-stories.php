...
$independentStories = [
    [
        ...
        "vocabs" => [
            "hypervigilance" => "a state of increased alertness and sensitivity to potential threats",
            "debilitating" => "causing a loss of strength or ability",
            "paucity" => "the presence of something in insufficient quantity",
