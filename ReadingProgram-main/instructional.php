<?php
    ...
    require_once 'instructional_config.php';
        ...
        if (isset($_POST['action'])) {
            switch ($_POST['action']) {
                ...
                case 'complete_activity':
                    ...
                    $_SESSION['activity_score'] = calculateScore($_SESSION['activity_answers'], $instructionalContent[$_SESSION['selected_activity']]['comprehension']);
                ...
                case 'submit_posttest':
                    ...
                    $_SESSION['posttest_score'] = calculateScore($_SESSION['posttest_answers'], $instructionalContent[0]['comprehension']);
                    ...
                    if ($gmrtResults) {
                        ...
                        // Save ALL results to database (GMRT + Instructional reading activity)
                        $saveResult = saveResultsToDatabase(
                            ...
                            // Instructional reading activity results (from instructional.php)
                        ...
                        // You might want to handle this case - maybe save only instructional.php results
    ...
    function saveResultsToDatabase(
        ...
        $data = [
            ...
            // Instructional reading activity results
        ...
        switch ($_SESSION['test_stage']) {
            case 'start':
                ...
                <div class="instructions">
                    <h3>Welcome to the Instructional Reading Level Test</h3>
                    <p>Based on your previous assessment, you've been identified as a instructional reader. This specialized test will help us better understand your reading abilities and provide targeted support.</p>
            ...
            case 'activity_combined':
                $activity = $instructionalContent[$_SESSION['selected_activity']];
                ?>
            ...
            // ADD NEW CASE FOR ACTIVITY RESULTS:
           ...
           case 'posttest_combined':
                $posttest = $instructionalContent[0];
                ?>
