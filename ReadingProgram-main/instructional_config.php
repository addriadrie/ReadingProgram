...
class DatabaseHelper {
    ...
    public function saveAllResults($data) {
        try {
            ...
            $sql = "CREATE TABLE IF NOT EXISTS instructional_results (
            ...
            // FIXED: Use the correct table name 'instructional_results' instead of 'complete_results'
            $sql = "INSERT INTO instructional_results (
                session_id,
    ...
    public function saveInstructionalResults($data) {
