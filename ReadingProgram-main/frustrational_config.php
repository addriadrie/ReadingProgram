...
class DatabaseHelper {
    ...
    public function saveAllResults($data) {
        try {
            ...
            $sql = "CREATE TABLE IF NOT EXISTS frustrational_results (
            ...
            // FIXED: Use the correct table name 'frustrational_results' instead of 'complete_results'
            $sql = "INSERT INTO frustrational_results (
                session_id,
    ...
    public function savefrustrationalResults($data) {
